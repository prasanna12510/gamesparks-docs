...
*2.* Click the plus ![](/img/fa/plus.png) icon to add a new Snippet:
...
*3.* Now, open up your *sales_view* Snippet so that we can see how this editor works:
...
*4.* To do this, select the *Insert* tab. Make sure you select the right collection from the drop-down menu:
